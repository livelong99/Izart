...
const ThreeC = () => {
    return(
        <div class="c3">
            ...
            <div class="steps">
                <div data-aos="fade-down" data-aos-delay="0" data-aos-offset="50" data-aos-duration="500" class="sContent">
                    <div class="step">
                    ...
                    <div data-aos="fade-down" data-aos-delay="900" data-aos-offset="50" data-aos-duration="500" class="arrow"><img class="rightAr" src="Images/arrow02.svg" /></div>
                    <div data-aos="fade-down" data-aos-delay="1200" data-aos-offset="50" data-aos-duration="500" class="step">
                ...
                <div class="sIllus"><img class="glow" src="Images/sIllus.svg" /><img class="ptArr" src="Images/grow.svg" /></div>
            </div>
        </div>
    )
}
